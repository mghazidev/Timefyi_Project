...
//         <button
//           className={cn(
//             "flex items-center gap-2 rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-400 hover:bg-zinc-800"
//           )}
//         >
...
//       <PopoverContent
//         className="w-[220px] bg-[#1E1E1E] border border-zinc-700 rounded-lg shadow-lg p-0"
//         align="end"
//       >
...
//         <div className="grid grid-cols-7 gap-1 text-center text-xs text-zinc-500 p-2 ">
//           {daysOfWeek.map((d) => (
  ...
  return (
    <Popover>
      ...
      >
        ...
        <div className="grid grid-cols-7 text-center px-2 text-xs text-zinc-500 bg-zinc-800 border-b border-zinc-700">
          {daysOfWeek.map((d) => (
